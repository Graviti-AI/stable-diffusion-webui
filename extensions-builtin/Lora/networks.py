...
def load_networks(
    ...
    compiled_lora_targets_for_hash = []
    for a, b, c in zip(networks_on_disk, unet_multipliers, te_multipliers):
        compiled_lora_targets.append([a, b, c])
        compiled_lora_targets_for_hash.append([a.hash, b, c])

    compiled_lora_targets_hash = str(compiled_lora_targets_for_hash)
    ...
    for net, strength_model, strength_clip in compiled_lora_targets:
