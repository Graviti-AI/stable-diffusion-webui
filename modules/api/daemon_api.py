...
class DaemonApi:
    ...
    @staticmethod
    def get_task_count():
        current_task, pending_tasks, _, finished_task_count, failed_task_count, consecutive_failed_task_count, force_restart, last_error_message, gpu_utilization = modules.progress.get_task_queue_info()
