...
def save_image(image, path, basename, seed=None, prompt=None, extension='png', info=None, short_filename=False, no_prompt=False, grid=False, pnginfo_section_name='parameters', p=None, existing_info=None, forced_filename=None, suffix="", save_to_dirs=None, *, skip_register=True):
    """Save an image.
    ...
    params = script_callbacks.ImageSaveParams(image, p, fullfn, pnginfo, skip_register=skip_register)
