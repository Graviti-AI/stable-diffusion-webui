...
def get_dict():
    ...
    res = {
        ...
        "Config": config,
        "Startup": launch_utils.startup_record,
...
def set_config(req: dict[str, Any], is_api=False, run_callbacks=True, save_config=True, *, all_model_info: AllModelInfo):
    ...
    for k, v in req.items():
        ...
        if k == 'sd_model_checkpoint':
            if v is None:
                main_entry.set_forge_checkpoint_info(None)
            else:
