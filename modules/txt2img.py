...
from modules.system_monitor import monitor_this_call


@monitor_this_call(
    is_intermediate=True,
    param_list=['steps', 'restore_faces', 'n_iter', 'batch_size', 'height', 'width', 'enable_hr', 'hr_scale', 'hr_second_pass_steps', 'hr_resize_x', 'hr_resize_y'])
