...
def create_sampler_and_steps_selection(choices, tabname):
    ...
    if opts.samplers_in_dropdown:
        with FormRow(elem_id=f"sampler_selection_{tabname}"):
            ...
            steps = gr.Slider(minimum=1, maximum=160, step=1, elem_id=f"{tabname}_steps", label="Sampling steps", value=20)
    else:
                        ...
                        with gr.Tabs(elem_id="mode_img2img"):
                            ...
                            with gr.TabItem('Batch', id='batch', elem_id="img2img_batch_tab") as tab_batch:
                                ...
                                with gr.Accordion("PNG info", open=False):
                                    ...
                                    img2img_batch_png_info_props = gr.CheckboxGroup(["Prompt", "Negative prompt", "Seed", "CFG scale", "Sampler", "Steps", "Model hash"], label="Parameters to take from png info", info="Prompts from png info will be appended to prompts set in ui.", interactive=False)
                    ...
                    value="<div class='user-content'>"
                            ...
                            "<div style='gap: 5px; display: flex; flex-direction: column; padding-bottom: 10px;'>"
                              "<div style='display: flex;'>"
                                ...
                                "<div id='upgrade' title='Unlock more credits' class='upgrade-content' style='display: none'><a href='/pricing_table'><img src='/public/image/lightning.png'/><span>Upgrade</span></a></div>"
