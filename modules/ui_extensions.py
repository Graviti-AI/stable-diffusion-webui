...
def install_extension_from_index(request: gr.Request, url, selected_tags, showing_type, filtering_type, sort_column, filter_text):
...
def refresh_available_extensions(request: gradio.routes.Request, url, selected_tags, showing_type, filtering_type, sort_column):
...
def refresh_available_extensions_for_tags(request: gradio.routes.Request, selected_tags, showing_type, filtering_type, sort_column, filter_text):
    code, _ = refresh_available_extensions_from_data(selected_tags, showing_type, filtering_type, sort_column, filter_text)
