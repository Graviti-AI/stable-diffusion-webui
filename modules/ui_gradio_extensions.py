...
def javascript_html(request: gr.Request):
    ...
    # head += '<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/vue@3.5.12"></script>\n'
    ...
    head += '<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/vuetify@2.4.0/dist/vuetify.js"></script>\n'
    # head += '<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/vuetify@3.6.14/dist/vuetify.js"></script>\n'
    # head += '<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/vuetify@3.6.14/dist/vuetify.js"></script>\n'
    # head += '<script type="text/javascript" src="/gallery-api/v1/gallery-app.js"></script>'
...
def css_html():
    ...
    # head += '<link rel="stylesheet" href="/gallery-api/v1/gallery-app.css">\n'
    head += '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/vuetify@2.4.0/dist/vuetify.min.css">\n'
    # head += '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/vuetify@3.6.14/dist/vuetify.min.css">\n'
