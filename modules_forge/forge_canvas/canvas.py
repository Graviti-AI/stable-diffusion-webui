...
class ForgeCanvas:
    def __init__(
        ...
        Context.root_block.load(None, js=f'async ()=>{{const forgeCanvas = new ForgeCanvas("{self.uuid}", {no_upload}, {no_scribbles}, {contrast_scribbles}, {height}, '
                                         ...
                                         f'initMobileCanvas(forgeCanvas)}}', queue=False)
